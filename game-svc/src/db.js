...
async function seedQuestions(p) {
  ...
  const questions = [
    ...
    { id: 'q8',  subject: 'science', difficulty: 0.2, content: 'What gas do plants absorb?',                      options: ['Oxygen','Nitrogen','Carbon Dioxide','Hydrogen'],        correct: 2, explanation: 'Plants absorb CO2 for photosynthesis' },
    { id: 'q9',  subject: 'science', difficulty: 0.5, content: 'What is the chemical symbol for water?',          options: ['WA','H2O','HO2','W2O'],                                correct: 1, explanation: 'Water is H2O' },
    { id: 'q10', subject: 'science', difficulty: 0.5, content: 'How many bones in the adult human body?',         options: ['196','206','216','226'],                                correct: 1, explanation: 'Adult humans have 206 bones' },
    { id: 'q11', subject: 'science', difficulty: 0.8, content: 'What is the speed of light in a vacuum?',        options: ['3x10^8 m/s','3x10^6 m/s','3x10^10 m/s','3x10^4 m/s'], correct: 0, explanation: 'Speed of light = 3x10^8 m/s' },
    ...
    { id: 'q13', subject: 'english', difficulty: 0.2, content: 'Which word is a noun?',                          options: ['Run','Happy','Dog','Quickly'],                          correct: 2, explanation: '"Dog" is a noun' },
    { id: 'q14', subject: 'english', difficulty: 0.2, content: 'What is the plural of "child"?',                 options: ['Childs','Childes','Children','Childrens'],              correct: 2, explanation: 'Irregular plural of child is children' },
    { id: 'q15', subject: 'english', difficulty: 0.5, content: 'Which uses correct punctuation?',                options: ["Its raining","It's raining","Its' raining","It is' raining"], correct: 1, explanation: "It's = it is" },
    ...
    { id: 'q19', subject: 'general', difficulty: 0.5, content: 'Who wrote "Romeo and Juliet"?',                  options: ['Charles Dickens','William Shakespeare','Mark Twain','Jane Austen'], correct: 1, explanation: 'Shakespeare wrote Romeo and Juliet' },
    { id: 'q20', subject: 'general', difficulty: 0.8, content: 'In what year did World War II end?',             options: ['1943','1944','1945','1946'],                            correct: 2, explanation: 'WWII ended in 1945' },
  ];

  for (const q of questions) {
    await p.query(
      `INSERT INTO questions (id, subject, difficulty, type, content_i18n, options_i18n, correct_option, explanation_i18n)
